...
// 반복의 경우도 조건과 같이 반복문 내부에 반복을 사용할 수 있음
...
// for 반복
// for(변수 in 변수)
// in 뒤에 있는 변수의 경우 딕셔너리 등을 사용, 뒤에 있는 변수의 key를 앞에 있는 변수에 넣어서 반복
...
// 실제로는 3중첩을 포함한 그 이상은 잘 사용안하는데 그 이유는 너무 오래 걸림

// for(let i = 1; i < 10; i++) {               // 총 9번 반복
//     for(let j = 1; j < 10; j++) {           // 총 81번 반복
//         console.log(i, "*", j, "=", i*j);
//     }
// }
...
// for(let i = 1; i < 6; i++) {
//     for(let j = 1; j <= i; j++) {       // 각 라인의 번째와 똑같은 수의 별을 출력하기 위해 밖에 있는 변수 사용
//         process.stdout.write('* ');     // 줄 바꿈 무시하면서 출력
//     }
//     console.log();                      // 줄이 끝날때 마다 엔터
// }
...
// for(let i = 1; i < 10; i++) {
//     for(let j = 1; j <= i; j++) {           // 조건에 밖에 있는 반복의 변수를 사용 가능
//         console.log(i, "*", j, "=", i*j);
//     }
// }